...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/stevedetm/restart-pod-job"}` | This sets the container image more information can be found here: https://kubernetes.io/docs/concepts/containers/images/ |
